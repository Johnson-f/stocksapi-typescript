...
const alpha_vantage_1 = require("../src/providers/alpha-vantage");
describe('AlphaVantageClient', () => {
    let client;
    const apiKey = process.env.ALPHA_VANTAGE_API_KEY || 'test-api-key';
    beforeEach(() => {
        client = new alpha_vantage_1.AlphaVantageClient(apiKey);
    ...
    describe('getTimeSeries', () => {
        it('should fetch time series data', async () => {
            ...
            client.makeRequest.mockResolvedValueOnce(mockTimeSeries);
