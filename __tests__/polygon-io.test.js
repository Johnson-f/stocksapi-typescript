...
const polygon_io_1 = require("../src/providers/polygon-io");
describe('PolygonIoClient', () => {
    ...
    beforeEach(() => {
        client = new polygon_io_1.PolygonIoClient(apiKey);
        // Mock the makeRequest method to avoid actual API calls during tests
        jest.spyOn(client, 'makeRequest').mockImplementation(async () => ({}));
    ...
    describe('getQuote', () => {
        it('should fetch a stock quote with historical data', async () => {
            ...
            client.makeRequest.mockResolvedValueOnce({
                results: [{
                        T: 'AAPL',
                        c: 151.00,
                        h: 151.25,
    ...
    describe('getCompanyProfile', () => {
        it('should fetch company profile data', async () => {
            ...
            client.makeRequest.mockResolvedValueOnce(mockProfile);
    ...
    describe('getTimeSeries', () => {
        it('should fetch time series data', async () => {
            ...
            client.makeRequest.mockResolvedValueOnce(mockData);
    ...
    describe('getEarnings', () => {
        it('should fetch earnings data', async () => {
            ...
            client.makeRequest.mockResolvedValueOnce(mockEarnings);
    ...
    describe('getUpcomingEarnings', () => {
        it('should fetch upcoming earnings data', async () => {
            ...
            client.makeRequest.mockResolvedValueOnce(mockUpcomingEarnings);
